# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-07-05 08:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('invoice_date', models.DateField(default=datetime.datetime(2018, 7, 5, 8, 44, 13, 30479, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('KG', 'KG'), ('Pc', 'Pc'), ('Pkt', 'Pkt')], default='KG', max_length=10)),
                ('apl', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.AnnualPriceList')),
